...
class lightning_model(L.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if (
            ...
            loss, psnr, pred, _ = self.forward(batch, kwargs, reshape=True)
            ...
            loss, psnr, pred, _ = self.forward(batch, kwargs, reshape=False)
...
class ffn(BaseModel):
    ...
    def __init__(self, cfg):
        ...
        self.final_activation = (
            nn.Identity() if self.final_activation is None else self.final_activation
        )
        layers.append(
            MLPLayer(
    ...
    def forward(self, x, **kwargs):
        ...
        # We want to break down the forward pass by layers
